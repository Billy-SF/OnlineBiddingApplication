...
<%@ page import="com.oa.helpers.ProductItem"%>
<%@ page import="com.oa.dao.SearchDao"%>
<%
	...
	<%
							//Stores the results
									while (rs.next()) {
										...
										ProductItem productitem = SearchDao.getProductItemByID(rs.getString("id"));
						%>
					...
					<table id="productitems" class="stripe">
						...
						<tbody>
							...
							<tr>
								<td><a
									href="bidPageDisplayServlet?productitemid=<%=rs.getString("id")%>"><%=rs.getString("itemname")%></a></td>
								<td><img
									<%--src="C:/uploadImageOttawAction/img1903941635699828845.jpg"  %><%--src="file:\\\\c:\uploadImageOttawAction\img1903941635699828845.jpg" src="c:\\uploadImageOttawAction\\<%=rs.getString("image")%>"--%> 
			<%-- src='chrome-extension://dhdebllgjlepmfjeignhkcmdklalodmd/<%=rs.getString("image")%>'alt="Auction Image"></td>--%>
				src='<%=rs.getString("image")%>'
									alt="Auction Image" height="250px" width="200px"></td>
