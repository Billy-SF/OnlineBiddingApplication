...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <li>
    <c:url value="sellerFeedback.jsp" var="englishURL"><c:param name="locale" value="en_US"/></c:url>
 	<a href="${englishURL}"><font size ="4" color="white"> <b>English</b></font> </a> </li>
 	
 	  <li>
 	<c:url value="sellerFeedback.jsp" var="chineseURL"><c:param name="locale" value="zh_CN"/></c:url>
