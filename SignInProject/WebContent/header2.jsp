...
<fmt:bundle basename="MessagesBundle">
	...
	<header id="header-wrap">
		...
		<nav class="navbar navbar-expand-md fixed-top scrolling-navbar nav-bg">
			<div class="container">
				...
				<c:url value="index.jsp" var="home1">
					...
					<a class="navbar-brand" href="${home1}"> <img 
						src="assets/img/logo.png" style="margin-top:10px; width: 180px; height: 90%;"
						alt="">
					</a>
			...
			<li><form class="navbar-form navbar-left" action="searchServlet">
					<div style="margin-top:8px;" class="input-group" style="height:35px;">
